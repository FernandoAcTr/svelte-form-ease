...
import { date } from '../lib/validators/date.validators.js';
...
describe('Date Validators', () => {
	...
	test('greaterThan', () => {
		...
		expect(
			date(new Date(2020, 1, 1))
				.greaterThan(new Date(2019, 0, 1), 'X')
				.validate()
		).toBeFalsy();
		expect(
			date('2020-02-01')
		...
		expect(
			date('2022-02-01')
				.greaterThan(new Date(2023, 0, 1), 'X')
				.validate()
		).toBe('X');
	});
	...
	test('range', () => {
		...
		expect(
			date(new Date(2020, 1, 1))
				.range(new Date(2019, 0, 1), new Date(2021, 0, 1), 'X')
				.validate()
		).toBeFalsy();
		expect(
			date('2020-02-05')
		...
		expect(
			date('2020-02-05')
				.range(new Date(2022, 0, 1), new Date(2023, 0, 1), 'X')
				.validate()
		).toBe('X');
		expect(
			date('2025-02-05')
